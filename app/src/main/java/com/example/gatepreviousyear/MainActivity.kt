...
class MainActivity : AppCompatActivity()  {
    ...
    fun Computer_eng(Computer_Engineering : mydbAdapter) {
          ...
          Computer_Engineering.insertData(201900005,getString(R.string.Question5_2019_set1),NULL, "","","","","")
          Computer_Engineering.insertData(201900006,getString(R.string.Question6_2019_set1),NULL, "","","","","")
          Computer_Engineering.insertData(201900007,"Compute : ",NULL, "","","","","")
